...
Since continuous scaling methods appear to be powerful, we were interested in whether this result could achieve a higher F1-score if we used other continuous scaling methods. Therefore, we reviewed the paper [_The Impact of Feature Scaling in Machine Learning: Effects on Regression and Classification Tasks_](https://arxiv.org/abs/2506.08274) and included ten additional scaling methods. Their formulas and results are shown below.
...
Since direct grid search for hyperparameter fine-tuning may waste time exploring less important parameter combinations, we adopt the random search method proposed in the paper _[Random Search for Hyper-Parameter Optimization](https://www.researchgate.net/publication/262395872_Random_Search_for_Hyper-Parameter_Optimization)_ for hyperparameter tuning. In this paper, the authors propose the following procedures for hyperparameter tuning.
...
4. Select the best hyperparameters based on macro F1 on the internal validation set.
...
| l2_regularization | 50% = 0，50% log-uniform |
...
| Parameter         |                Value |
| ----------------- | -------------------: |
| learning_rate     | 0.040865203745585200 |
| max_iter          |                  224 |
| max_leaf_nodes    |                  120 |
| min_samples_leaf  |                   45 |
| l2_regularization |                  0.0 |
| train_accuracy    |             0.662802 |
| train_macro_f1    |             0.637082 |
| eval_accuracy     |             0.600438 |
| eval_macro_f1     |             0.560415 |
