...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        description: "step-by-step solution to the MLE online assignment provided by VICI Holdings",
        section: "Posts",
        handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%73%69%75%79%65%65.%73%63%31%31@%6E%79%63%75.%65%64%75.%74%77", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/hsiuyee", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/hsiu-i-liao-687829268", "_blank");
        },
      },{
      id: 'light-theme',
